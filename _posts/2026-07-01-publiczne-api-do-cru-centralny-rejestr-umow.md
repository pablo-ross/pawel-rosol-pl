---
title: "Publiczne API do CRU (Centralny Rejestr Umów) — jak pobrać dane bez klikania po jednej umowie"
...
tags:
  ...
  - curl
  - rejestrumow.gov.pl
description: "Od 1 lipca 2026 r. działa Centralny Rejestr Umów (CRU). Sprawdziłem, jak wygląda publiczne API do CRU na rejestrumow.gov.pl — jest ukryty endpoint JSON, z którego można pobrać dane bez logowania. Pokazuję gotowe przykłady w curl oraz drugie, oficjalne API Ministerstwa Finansów z autoryzacją X-API-KEY."
---
...
Strona `rejestrumow.gov.pl` to aplikacja napisana w Angularze. A takie aplikacje nie mają danych „w sobie" — pobierają je z jakiegoś API w tle. Wystarczyło otworzyć narzędzia deweloperskie w przeglądarce (klawisz `F12`, zakładka *Network*), żeby zobaczyć, skąd strona bierze umowy.
