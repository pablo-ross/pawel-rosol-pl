...
faq:
  ...
  - question: "Czy MPK Kraków zgłosiło incydent do UODO i w jakim terminie należało to zrobić?"
...
Atak wywołał obawy dotyczące możliwego naruszenia ochrony danych osobowych pracowników oraz pasażerów. Choć do tej pory brak potwierdzenia, że doszło do kradzieży danych, MPK zgłosiło incydent do Prezesa Urzędu Ochrony Danych Osobowych (PUODO). Zgodnie z [RODO](https://eur-lex.europa.eu/eli/reg/2016/679/oj) (art. 33), administratorzy danych osobowych są zobowiązani do zgłaszania naruszeń w ciągu 72 godzin od ich wykrycia, jeśli istnieje ryzyko naruszenia praw lub wolności osób fizycznych. Jak ten obowiązek wygląda w praktyce - co liczy się jako „stwierdzenie” naruszenia, kiedy trzeba zawiadomić osoby i co wpisać do rejestru - opisuję w [przewodniku po naruszeniach ochrony danych]({% post_url 2026-09-21-naruszenie-ochrony-danych-przewodnik %}). MPK zapewniło również, że w przypadku stwierdzenia naruszenia poufności danych poszkodowani zostaną poinformowani o sytuacji​.
...
W świetle [dyrektywy NIS2](https://eur-lex.europa.eu/eli/dir/2022/2555/oj), która rozszerza zakres ochrony kluczowych usług infrastrukturalnych, atak ten podkreśla konieczność wdrożenia zaawansowanych systemów zabezpieczeń cybernetycznych w przedsiębiorstwach infrastrukturalnych, takich jak MPK. O tym, co wdrożenie tych wymagań oznacza w praktyce, pisałem we wpisie [Potrzeba implementacji NIS2 w przedsiębiorstwie]({% post_url 2024-11-20-wdrozenie-implementacja-nis2 %}). Dyrektywa nakłada na firmy obowiązek oceny ryzyka i wprowadzenia procedur reagowania na incydenty. Współpraca MPK z wyspecjalizowanymi firmami IT i służbami państwowymi może być uznana za przykład działania zgodnego z założeniami NIS2, jednak incydent ujawnia potrzebę jeszcze lepszej koordynacji i przygotowania na wypadek ataków tego rodzaju​.
